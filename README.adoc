...
. For the scripts to work, you nned to install `jq` which is a sed-like tool for working with JSON data. You can find it [here](https://stedolan.github.io/jq/download/).
